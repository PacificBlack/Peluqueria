...
public class Reservas {
    String numero_cliente, idententificacion_peluquero, detalle_servicio, precio_servicio,
            pago_servicio, estado_servicio, fecha_servico;

    public Reservas() {
    }

    public Reservas(String numero_cliente, String idententificacion_peluquero, String detalle_servicio, String precio_servicio, String pago_servicio, String estado_servicio, String fecha_servico) {
